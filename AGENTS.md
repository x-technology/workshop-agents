...
| **Agent loop / orchestration** | Subagents, tool loops, hooks                                                 | Agents + handoffs                                                                           | Pipelines (seq/parallel) ⚠️ _(loop flexibility unclear)_  | Tool-based loops (lightweight)                            | **LangGraph DAG + cycles (full state machines)**                                                                                                          |
...
| **Tools**                      | MCP, bash, browser, file system                                              | Function calling, tools, MCP                                                                | Google tools + functions ⚠️ _(MCP maturity?)_             | Tool calling, MCP                                         | 500+ integrations                                                                                                                                         |
...
| **Multi-agent**                | Subagents ⚠️ _(basic vs true orchestration)_                                 | Native handoffs                                                                             | A2A protocol ⚠️ _(early stage)_                           | ❌ Limited                                                | ✅ Advanced (LangGraph multi-node)                                                                                                                        |
...
- Replace ad-hoc HTTP logic with one focused ADK agent
- Keep the classification contract explicit before introducing multiple agents in step `03`
...
- step `02` is only the classifier foundation for later steps
- multi-agent behavior starts in step `03`, not here
...
- step `04` reuses the step `02` classifier and the step `03` specialists
...
- wraps the step `02` classifier plus the step `03` specialists
